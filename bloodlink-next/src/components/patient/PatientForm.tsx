...
interface PatientFormProps {
    ...
    onCancel?: () => void;
    onConfirm?: (data: Partial<Patient>) => void | Promise<void>;
    isEdit?: boolean;
    title?: string;
}

export function PatientForm({ initialData = {}, onCancel, onConfirm, isEdit = false, title }: PatientFormProps) {
    ...
    const [formData, setFormData] = useState<Partial<Patient>>({
        ...
        process: initialData.process || 'รอตรวจ',
    ...
    return (
        <div className="w-full flex justify-center items-start font-[family-name:var(--font-prompt)]">
