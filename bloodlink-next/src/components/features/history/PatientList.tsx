    ...
    return (
        <>
            ...
            <ConfirmModal
                ...
                onConfirm={handleInitOrderLab}
                title="ยืนยันการสั่งเจาะเลือด"
                description="ต้องการสั่งเจาะเลือดผู้ป่วยที่เลือกใช่หรือไม่? (ระบบจะส่งเรื่องไปที่ห้องแล็บเพื่อรอรับเรื่องและต้องใส่ PIN เพื่อลงนามทางอิเล็กทรอนิกส์)"
                confirmText="ถัดไป"
                cancelText="ยกเลิก"
                variant="primary"
