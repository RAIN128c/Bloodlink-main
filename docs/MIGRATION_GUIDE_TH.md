# คู่มือการอัปเกรดระบบ Bloodlink (สำหรับผู้ที่ Fork ไปแล้ว)

เนื่องจากมีการปรับปรุงระบบครั้งใหญ่เพื่อรองรับการ **"อัปเดตอัตโนมัติ" (Auto-Update)**
สำหรับท่านที่ทำการ Fork โปรเจคไปแล้ว จำเป็นต้องดำเนินการดังนี้ **เพียงครั้งเดียว** เพื่อติดตั้งระบบครับ

หลังจากทำขั้นตอนนี้เสร็จ ระบบของท่านจะอัปเดตตามต้นฉบับเองทุกเที่ยงคืนโดยอัตโนมัติ!
...
**เสร็จสิ้น!** 🎉
หลังจากนี้ ระบบของท่านจะทำการตรวจสอบและดึงอัปเดตจากต้นฉบับ (Upstream) มาทับเองทุกคืน ท่านไม่ต้องกด Sync เองอีกต่อไป
